...
{{define "content"}}
<h1 class="text-2xl font-bold mb-6">上传工具</h1>
<div class="bg-white p-6 rounded shadow">
<form method="post" enctype="multipart/form-data">
  <input type="hidden" name="_xsrf" value="{{.xsrf_token}}">
  <div class="mb-4">
    <label class="block mb-1 font-medium">工具名称</label>
  ...
  <button class="bg-blue-600 text-white px-4 py-2 rounded">上传并发布</button>
</form>
</div>
{{end}}
